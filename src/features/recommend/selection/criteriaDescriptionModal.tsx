...
export default function CriteriaDescriptionModal({
  ...
  return createPortal(
    <div
      className='fixed inset-0 z-[100] flex items-center justify-center bg-black/60 px-[1.375rem]'
      onClick={onClose}
      style={{ height: '100dvh' }}
    >
      <div
        className='animate-slide-up relative flex w-full max-w-[20.625rem] flex-col items-center'
